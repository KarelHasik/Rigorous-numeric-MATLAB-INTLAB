...
% Display final results jintval ans = 0.25155062058162, j = 12, M(j) = 0.2515506205816198, M(j+1) = 0.2515506205816199
format long 
M(j)
disp(['j = ', num2str(j)])
disp(['M(j) = ', num2str(sup(M(j)),16)])
disp(['M(j+1) = ', num2str(sup(M(j+1)),16)])
